...
Ce modèle de données fait partie et respecte les exigences du [Socle Commun des Données Locales](broken-reference). Il repose sur les **`6 champs`** suivants correspondant aux colonnes du fichier tabulaire.

#### `COMMUNE_NOM` <a href="communenom" id="communenom"></a>
...
#### `COLL_INSEE` <a href="collinsee" id="collinsee"></a>
...
#### `ENFANT_SEXE` <a href="enfantsexe" id="enfantsexe"></a>
...
#### `NOMBRE_OCCURRENCES` <a href="nombreoccurrences" id="nombreoccurrences"></a>
